                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fullname" name="fullname"
                                    value="" placeholder="Nhập vào tên người dùng">
                            </div>
                            <div class="form-group">
                                <label for="id_card">ID Card</label>
                                <input type="number" class="form-control" id="id_card" name="id_card"
                                    value="" placeholder="Nhập vào mã thẻ thư viện">
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" id="email" name="email"
                                    value="" placeholder="Nhập vào email">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                value="" placeholder="Nhập vào ngày sinh">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                value="" placeholder="Nhập vào số điện thoại">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                value="" placeholder="Nhập vào số thẻ">
                            </div>
                            <div class="form-group">
